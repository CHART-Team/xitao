...
/* Name of package */
#define PACKAGE "dependency_benchmarks_ompss"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "josep.m.perez@bsc.es"

/* Define to the full name of this package. */
#define PACKAGE_NAME "dependency_benchmarks_ompss"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dependency_benchmarks_ompss svn"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dependency_benchmarks_ompss"
